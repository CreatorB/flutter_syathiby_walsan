...
class _$SurahImpl implements _Surah {
  ...
  @override
  String toString() {
    return 'Surah(nomor: $nomor, nama: $nama, namaLatin: $namaLatin, jumlahAyat: $jumlahAyat, tempatTurun: $tempatTurun, arti: $arti, deskripsi: $deskripsi, audio: $audio)';
  }
...
abstract class _Surah implements Surah {
  const factory _Surah(
      ...
      required final String audio}) = _$SurahImpl;
