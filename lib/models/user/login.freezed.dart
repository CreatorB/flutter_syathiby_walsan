...
mixin _$Login {
  ...
  dynamic get packages => throw _privateConstructorUsedError;
...
class _$LoginImpl implements _Login {
  ...
  @override
  String toString() {
    return 'Login(key: $key, token: $token, currency: $currency, user: $user, level: $level, master: $master, packages: $packages, typestore: $typestore, decimal: $decimal, id_store: $id_store, device: $device)';
  }
